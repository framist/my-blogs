...
在下面的示例中，参数`scheduler`是来自的LR scheduler对象`torch.optim.lr_scheduler`。
...
[【学习笔记】如何理解 transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))\])_GRIT_Kael的博客-CSDN博客_transforms.normalize参数](https://blog.csdn.net/KaelCui/article/details/106175313)
