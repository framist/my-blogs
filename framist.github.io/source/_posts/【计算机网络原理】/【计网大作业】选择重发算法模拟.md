...
![Image](https://img-blog.csdnimg.cn/img_convert/2436faf2c80ca8a32189efa9204ba866.png)



# 选择重发 ARQ 算法模拟 —— 基于真实硬件线路

*开源地址：[framist/ARQEmulator: 计算机网络 - 选择重发ARQ算法模拟 - 基于真实硬件线路 (github.com)](https://github.com/framist/ARQEmulator)*

*fork from ：[framist/STemWinForHAL: 移植emWin与HAL库结合。(github.com)](https://github.com/framist/STemWinForHAL)*
...
- 数据通信与网络（原书第4版）作者：（美）佛罗赞，（美）费根 著，吴时霖 等译
